...
const sttaddr = "0xcb7b4bc4e7c10124c7b62d96df793126b01d29b3";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0xcb7b4bc4e7c10124c7b62d96df793126b01d29b3";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://miratoken.net?ref=' + document.getElementById('refaddress').value;
        }
    }
}
